...
url = "https://www.keurslager-david.be/be-nl/keurslager-david/overview"
...
with open("slagerOutput.json", "w") as outfile:
    outfile.write(output_json)

print("Scraped data has been successfully written to 'slagerOutput.json'.")
